export PROJECT_ROOT="/Users/jlam/Documents/Blog/jenkins-pipeline-scripts"
export HOST_ROOT="/private/pipeline-demo"
...
export BACKEND_DOCKERFILE_FOLDER="${PROJECT_ROOT}/dockers/backend/"
...
export FRONTEND_DOCKERFILE_FOLDER="${PROJECT_ROOT}/dockers/frontend/"
